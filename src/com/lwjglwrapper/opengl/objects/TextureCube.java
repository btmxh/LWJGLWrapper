...
public class TextureCube extends Texture{
    ...
    public static final int FILE_MODE = 0, RESOURCE_MODE = 1;
    
    public TextureCube(int pathMode, String f0, String f1, String f2, String f3, String f4, String f5) {
    ...
    public TextureCube(int pathMode, String dir, String ext, String f0, String f1, String f2, String f3, String f4, String f5) {
        this(pathMode,
             dir + "/" + f0 + "." + ext,
             dir + "/" + f1 + "." + ext,
             dir + "/" + f2 + "." + ext,
    ...
    public TextureCube(int pathMode, String dir, String ext) {
        this(pathMode, dir, ext, "right", "left", "top", "bottom", "back", "front");
    }
